#ifndef __TATP_BATCH_PROCESSOR_H__
#define __TATP_BATCH_PROCESSOR_H__
...
namespace IMDB {
	namespace Benchmark {
		namespace TATP {
			...
			class TatpBatchProcessor : public TatpBaseProcessor {
			public:
				TatpBatchProcessor(lockfree_queue_t* const queue_ptr, StorageManager* const sm, const ScaleParams* params)
			...
			private:
				...
				TatpBatchProcessor(const TatpBatchProcessor&);
				TatpBatchProcessor& operator=(const TatpBatchProcessor&);
